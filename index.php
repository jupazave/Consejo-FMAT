  ...
  <div class="sidebar">
    <div class="container sidebar-sticky">
      ...
      <img src="public/img/CE_MATE.png" alt="">
        ...
        <p class="lead">Sitio de Noticias de Consejo FMAT</p>
      </div>

      <nav class="sidebar-nav">
        <?php foreach($noticias as $noticia):?>
        <a class="sidebar-nav-item" href="ver_noticia.php?id=<?php echo $noticia['id_noticia']; ?>"><?php echo $noticia['titulo']?></a>
        <?php endforeach ?>
      </nav>
